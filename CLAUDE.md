...
# Train the digit recognition model (outputs model_wojtka.pth)
python trainer.py
```
...
- **`model.py`** — `get_trained_model()`: loads the ResNet18 model from `model_wojtka.pth`
...
- Trained OCR model file: `model_wojtka.pth` (~43MB, gitignored)
